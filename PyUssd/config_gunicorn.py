...
#LOGGING
accesslog=os.path.join(BASE_DIR,'logs/access.log') # default is None (for no logging)
...
#PROCESS NAMES
proc_name = 'PyUssd' #default is None

#OTHERS
chdir=BASE_DIR #change dir before loading apps
forwarded_allow_ips="127.0.0.1" #set to * to disable checking IPs.
pythonpath=None #Default is None. List od dirs to add to Python Path e.g '/home/djangoprojects/myproject,/home/python/mylibrary'
